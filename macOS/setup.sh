...
# Load Homebrew into this shell (Apple Silicon or Intel).
load_brew() {
...
DO_LINKS=1 DO_BREW=1 DO_BUNDLE=1 DO_SHELL=1 DO_ENV=1 DO_NVIM=1 DO_ASDF=1

while [ $# -gt 0 ]; do
  case "$1" in
    --links-only) DO_BREW=0; DO_BUNDLE=0; DO_SHELL=0; DO_ENV=0; DO_NVIM=0; DO_ASDF=0 ;;
    --no-links)   DO_LINKS=0 ;;
